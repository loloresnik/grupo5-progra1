    ...
    while True:
        ...
        if opcion == "1":
            ...
            while True:
                ...
                print("4. Top 3 menos vendidos")
                print("5. Recaudación total")
                print("6. Producto más caro")
                print("7. Producto menos caro")
                print("8. Valor total del stock")
                print("9. Valor por categoría")
                print("10. Porcentaje por categoría")
                print("11. Buscar por proveedor")
                print("12. Buscar por categoría")
                print("13. Promedio de precio")
                print("14. Precios con IVA")
                print("15. Valor total con reduce")
                print("16. Productos sin stock")
                print("0. Volver")
                ...
                if op == "1":
                    ...
                    while re.match(r"^\d+$", cantidad) is None:
                        print("La cantidad debe ser numérica.")
                        cantidad = input("Cantidad vendida: ").strip()
                    cantidad = int(cantidad)

                    registrar_venta(ventas_dic, productos_dic, id_prod, cantidad)
